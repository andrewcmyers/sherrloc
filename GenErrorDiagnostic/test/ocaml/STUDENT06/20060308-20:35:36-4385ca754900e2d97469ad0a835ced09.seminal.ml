...
let rec xmlToDoc xml =
	let rec attrsToDoc attrList =
		...
		in match attrList with
			hd::tl ->
				group [printAttr hd ; br ; attrsToDoc tl]
	in match xml with
		Element(str, attributes, children) ->
			group [text "<" ; br ; text str ;
				   group [nest 2 [br ; attrsToDoc attributes ; br ; text ">"] ] ;
				   group [nest 4 [br ; xmlToDoc children] ] ;
				   br ; text "</" ; br ; text str ; br ; text ">"]
