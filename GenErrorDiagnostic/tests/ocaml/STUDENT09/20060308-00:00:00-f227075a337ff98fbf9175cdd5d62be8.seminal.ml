...
let rec xmlToDoc xml = 
	...
	let rec xmlDoc xmlList = Pprintdata.group [eDoc; Pprintdata.text " "; attDoc; Pprintdata.text ">\n";] in
	match xmlList with
	  [] -> Pprintdata.text ""
	| hd::tl->Pprintdata.group [xmlDoc; xmlToDoc hd; xmlDoc tl;  Pprintdata.text "/"; Pprintdata.text eName; Pprintdata.text ">"]
(******************** pretty-printer test *************)
