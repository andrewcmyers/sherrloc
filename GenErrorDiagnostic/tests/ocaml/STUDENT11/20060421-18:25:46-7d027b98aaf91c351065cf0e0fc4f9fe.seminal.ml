...
let client3 (impl : ('a,'b) t3) =
  impl.incr3 impl.ctr3;
  impl.print3 impl.ctr3;
  let decr = impl.allowDecr3 impl.ctr3 in
  impl.decr3 decr;
  impl.ctr3 
...
let useTypes (impl : 'a t1) =
  (client3 {ctr3=impl.ctr1;
           incr3=impl.incr1;
           allowDecr3=(fun c -> impl.allowDecr1 c; (impl.decr1,c));
           decr3=(fun d ->  
                       let (decr,c) = d in
                       decr c);
           print3=impl.print1})
...
let _ = print_string (string_of_int(dynamicCheck impl)); print_endline ""
let _ = print_string (string_of_int(withholdDecr impl)); print_endline ""
(**)
let _ = print_string (string_of_int(useTypes impl)); print_endline ""
(**)
