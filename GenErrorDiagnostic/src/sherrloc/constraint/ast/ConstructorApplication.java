...
/**
 * This class represents an application of a {@link Constructor}, possibly with no parameters (e.g.,
 * list int, int)
 */
public class ConstructorApplication extends Application {
    ...
    /**
     * Special handling is need to lift the "topness". For example, in Jif, Top->Top, where Top is
     * the top element in the lattice of principals, is the top element in the lattice of labels
     */
    @Override
