...
/**
 * A constructor (e.g., list(1), pair(2)) has a name, an arity and the variance of parameters
 */
public class Constructor extends Element {
    ...
    /**
     * Set arity of a constructor (used only in varMode, where constructors are inferred from the
     * constraint file)
     */
    ...
    /**
     * @return Return the variance of all parameters (all parameters must have the same variance in
    ...
    public boolean equals(Object o) {
        if (o instanceof Constructor) {
            ...
            return arity == c.arity && this.name.equals(c.name) && this.variance == c.variance
                    && this.pos.equals(c.pos);
        }
        return false;
    }
    ...
    @Override
    public int hashCode() {
        return arity * 85751 + name.hashCode() * 1913 + pos.hashCode() * 3
                + (this.variance.hashCode());
    }
