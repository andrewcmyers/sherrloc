...
/**
 * This class represents an application to a constructor, possibly with no parameters (e.g., list
 * int, int)
 * <p>
 * The constructor can either be concrete {@link Constructor}, or abstract {@link Variable}
 */
public abstract class Application extends EnumerableElement {
    ...
    /**
     * Return a (all) new applications where e1 is replaced with e2. For instance, '(String,
     * String)'.replace('String', 'Name')' should return: ['(Name, String)', '(String, Name)',
     * '(Name, Name)']
     */
    public abstract List<Application> replace(Element e1, Element e2);

    /**
     * A help method that takes a list of elements to be replaced (elements), and updates all
     * possible replacements so far (ret)
     *
     ...
     */
    protected void _replace(List<Element> elements, int idx, Element e1, Element e2,
            List<List<Element>> ret) {
