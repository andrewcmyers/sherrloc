...
/**
 * This class represents an application of a {@link Variable}, possibly with no parameters (e.g., x
 * int, x)
 */
public class VariableApplication extends Application {
    ...
    public boolean unifyWith(Element e, Map<QuantifiedVariable, Element> map) {
        if (e instanceof Application) {
            if (e instanceof ConstructorApplication && !var.unifyWith(
                    ((ConstructorApplication) e).getCons(), map)) {
                return false;
            }
            if (e instanceof VariableApplication && !var.unifyWith(
                    ((VariableApplication) e).getCons(), map)) {
                return false;
            }
    ...
    public boolean matches(Element e, Map<Variable, Element> map) {
        if (e instanceof Application) {
            if (e instanceof ConstructorApplication && !var.matches(
                    ((ConstructorApplication) e).getCons(), map)) {
                return false;
            }
            if (e instanceof VariableApplication && !var.matches(
                    ((VariableApplication) e).getCons(), map)) {
                return false;
            }
