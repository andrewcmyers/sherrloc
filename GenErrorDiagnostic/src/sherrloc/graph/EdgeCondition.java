...
/**
 * Information needed for an edge representing constructors, including constructor, index of the
...
public class EdgeCondition {
    ...
    /**
     * @param con     The concrete constructor being applied to
     * @param index   The index of the parameter, in the constructor, that the edge is connecting
     *                to
     * @param reverse True if the edge is from constructor to a parameter
     * @param v       Variance of the parameter
     */
    ...
    /**
     * @param var     The constructor variable to be applied to
     * @param index   The index of the parameter, in the constructor, that the edge is connecting
     *                to
     * @param reverse True if the edge is from constructor to a parameter
     * @param v       Variance of the parameter
