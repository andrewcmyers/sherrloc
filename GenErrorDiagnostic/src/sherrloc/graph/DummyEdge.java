...
/**
 * A dummy edge used when non-consecutive edges are connected to produce an LEQ edge (e.g., when all
 * components of a join element <= another element). The main purpose is to make the inferred path
 * start/end at the right node
 */
