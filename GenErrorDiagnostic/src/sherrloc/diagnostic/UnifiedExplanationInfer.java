...
/**
 * An experimental inference algorithm that finds a smallest combination of expressions and missing
 * hypothesis that best explain all program analysis errors. This algorithm simply ranks the
 * combined suggestions by size. Despite its simplicity, the result is still useful since this
...
public class UnifiedExplanationInfer extends InferenceEngine {
    ...
    /**
     * @param paths All unsatisfiable paths identified in constraint analysis
     */
