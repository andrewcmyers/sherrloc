...
/**
 * Entities are the basic units of error report. In OCaml, the entities are program expressions; in
 * Jif, the entities can be security labels or information-flow constraints; for missing hypothesis,
 * the entities are hypothesis.
 * <p>
...
public abstract class Entity {
    ...
    /**
     * @param succ # satisfiable paths using the entity
     */
     ...
     * expression/constraint appears on path p, or a hypothesis suppresses the error on path p
     */
     ...
     *
     * @param locBuf Location of the explanation
     * @param expBuf Explanation
     */
