...
{-# INLINE happyOut14 #-}
happyIn15 :: (Entry) -> (HappyAbsSyn )
happyIn15 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn15 #-}
happyOut15 :: (HappyAbsSyn ) -> (Entry)
...
{-# INLINE happyOut16 #-}
happyIn17 :: (Category) -> (HappyAbsSyn )
happyIn17 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn17 #-}
happyOut17 :: (HappyAbsSyn ) -> (Category)
...
{-# INLINE happyOut23 #-}
happyIn24 :: ((String, String, Int)) -> (HappyAbsSyn )
happyIn24 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn24 #-}
happyOut24 :: (HappyAbsSyn ) -> ((String, String, Int))
...
{-# INLINE happyOut29 #-}
happyIn30 :: (Ty) -> (HappyAbsSyn )
happyIn30 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn30 #-}
happyOut30 :: (HappyAbsSyn ) -> (Ty)
happyOut30 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut30 #-}
happyIn31 :: (TyCon) -> (HappyAbsSyn )
happyIn31 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn31 #-}
happyOut31 :: (HappyAbsSyn ) -> (TyCon)
...
happyActOffsets = HappyA# ""#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# ""#

happyDefActions :: HappyAddr
happyDefActions = HappyA# ""#

happyCheck :: HappyAddr
happyCheck = HappyA# ""#

happyTable :: HappyAddr
happyTable = HappyA# ""#
...
happyReduction_24 (happy_x_4 `HappyStk`
	...
	case happyOut16 happy_x_4 of { happy_var_4 -> 
	happyIn13
		 (PrimClassSpec { cls = happy_var_2, desc = happy_var_3, opts = happy_var_4 }
	) `HappyStk` happyRest}}}
...
happyNewToken action sts stk
	...
	TVECTOR -> cont 35#;
	TVECTUPLE -> cont 36#;
	TThatsAllFolks -> cont 37#;
	TLowerName happy_dollar_dollar -> cont 38#;
	TUpperName happy_dollar_dollar -> cont 39#;
	TString happy_dollar_dollar -> cont 40#;
	TInteger happy_dollar_dollar -> cont 41#;
	TNoBraces happy_dollar_dollar -> cont 42#;
	_ -> happyError' tk
	})
