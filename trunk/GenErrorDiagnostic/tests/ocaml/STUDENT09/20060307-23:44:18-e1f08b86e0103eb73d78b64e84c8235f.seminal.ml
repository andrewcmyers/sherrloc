...
let rec xmlToDoc xml = 
	...
	let xmlDoc = Pprintdata.group [eDoc; Pprintdata.text " "; attDoc; Pprintdata.text ">\n";] in
	match xmlList with
	  [] -> Pprintdata.text ""
	| hd::tl-> Pprintdata.group [xmlDoc; xmlToDoc hd; xmlToDoc xmlList;  Pprintdata.text "/"; Pprintdata.text eName; Pprintdata.text ">"]
