...
let rec xmlToDoc xml = 
	...
	let rec xmlDoc = Pprintdata.group [eDoc; Pprintdata.text " "; attDoc; Pprintdata.text ">\n";] in
	    Pprintdata.group [xmlDoc; map xmlToDoc xmlList;  Pprintdata.text "/"; Pprintdata.text eName; Pprintdata.text ">"]
