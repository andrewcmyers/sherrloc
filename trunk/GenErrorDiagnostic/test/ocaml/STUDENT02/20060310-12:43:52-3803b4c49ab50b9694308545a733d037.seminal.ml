...
let rec stmtToDoc stmt = 
  match stmt with
    Skip -> empty
  | Assign(str, e) -> 
      group [text str ; br ; text ":=" ; br ; expToDoc e]
  | Seq(s1, s2) -> 
      smartcons (group [stmtToDoc s1 ; text ";"]) (conslist[br ; stmtToDoc s2])
  | If(e, s1, s2) ->
      group [text "if" ; br ; expToDoc e ; br ;
					text "(" ; br ; stmtToDoc s1 ; br ; 
					stmtToDoc s2 ; br ; text ")"]
  | While(e, s) -> 
      group [text "while" ; br ; expToDoc e ; br ;
					text "(" ; br ; stmtToDoc s ; br ; 
					text ")"]
