...
let wrap_paren doc =
  Pprintdata.smartcons (Pprintdata.text "(") (Pprintdata.smartcons doc (Pprintdata.text ")"))
let rec stmtToDoc stmt = 
  ...
  | Seq (stmt1, stmt2) -> Pprintdata.smartcons (stmtToDoc stmt1) (Pprintdata.smartcons (Pprintdata.text ";") (stmtToDoc stmt2))
  | If (e, stmt1, stmt2) -> Pprintdata.smartcons (Pprintdata.text "if") (Pprintdata.smartcons (expToDoc e) (Pprintdata.smartcons (wrap_paren (stmtToDoc stmt1)) (wrap_paren (stmtToDoc stmt2))))
  | While (e, s) -> Pprintdata.smartcons (Pprintdata.text "while") (Pprintdata.smartcons (expToDoc e) (wrap_paren s))
